...
#pragma once
#ifndef e400FirmwarePlugin_H
#define e400FirmwarePlugin_H

#include "APMFirmwarePlugin.h"
#include "FirmwarePlugin.h"

class E400PlaneMode: public APMCustomMode
{
public:
    enum Mode {
        MANUAL        = 0,
    ...
    E400PlaneMode(uint32_t mode, bool settable);
};

class E400FirmwarePlugin : public APMFirmwarePlugin
{
    Q_OBJECT

public:
    E400FirmwarePlugin(void);
