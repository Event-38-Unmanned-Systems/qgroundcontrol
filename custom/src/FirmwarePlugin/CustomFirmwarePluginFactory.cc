...
CustomFirmwarePluginFactory::CustomFirmwarePluginFactory(void)
    ...
    , _customFirmwarePluginInstance(nullptr)
{
...
FirmwarePlugin* CustomFirmwarePluginFactory::firmwarePluginForAutopilot(MAV_AUTOPILOT autopilotType, MAV_TYPE vehicleType)
{
    if (autopilotType == MAV_AUTOPILOT_ARDUPILOTMEGA) {
        ...
        case MAV_TYPE_FIXED_WING:
            if (!_customFirmwarePluginInstance) {
            _customFirmwarePluginInstance = new CustomFirmwarePlugin;
            }
            return _customFirmwarePluginInstance;
