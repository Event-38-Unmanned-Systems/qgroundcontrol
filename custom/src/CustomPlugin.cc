...
bool CustomPlugin::adjustSettingMetaData(const QString& settingsGroup, FactMetaData& metaData)
{
    ...
    if (settingsGroup == AppSettings::settingsGroup) {
        ...
        if (metaData.name() == AppSettings::offlineEditingFirmwareClassName) {
            ...
            metaData.setRawDefaultValue(QGCMAVLink::VehicleClassVTOL);
            return false;
        }
    }
...
void CustomPlugin::paletteOverride(QString colorName, QGCPalette::PaletteColorInfo_t& colorInfo)
{
    if (colorName == QStringLiteral("window")) {
        ...
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupEnabled]  = QColor("#fdfdfd");
        ...
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupEnabled]  = QColor("#fdfdfd");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupDisabled] = QColor("#fdfdfd");
    }
        ...
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupEnabled]   = QColor("#fdfdfd");
        colorInfo[QGCPalette::Dark][QGCPalette::ColorGroupDisabled]  = QColor("#fdfdfd");
        colorInfo[QGCPalette::Light][QGCPalette::ColorGroupEnabled]  = QColor("#212529");
