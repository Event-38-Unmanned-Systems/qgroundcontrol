...
Item {
    ...
    property bool showTakeoff:          false
    ...
    property bool showGimbalROI:        _guidedActionsEnabled && _vehicleFlying && QGroundControl.videoManager.streaming
    ...
    property bool showResumeMission:    false //_activeVehicle && !_vehicleArmed && _vehicleWasFlying && _missionAvailable && _resumeMissionIndex > 0 && (_resumeMissionIndex < _missionItemCount - 2)
    ...
    function confirmAction(actionCode, actionData, mapIndicator) {
        ...
        case actionGimbalROI:
            confirmDialog.title = gimbalRoiTitle
